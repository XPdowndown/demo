      ...
      <div class="cart-body">
        <ul class="cart-list" v-for="(cart) in cartInfoList" :key="cart.id">
          <li class="cart-list-con1">
            <input type="checkbox" :checked="cart.isChecked" @click="changeChecked(cart, $event)" name="chk_list">
          </li>
          ...
          <li class="cart-list-con7">
            <a href="#none" class="sindelet" @click="deleteCartList(cart, $event)">删除</a>
            <br>
            <a href="#none">移到收藏</a>
          </li>
        </ul>
