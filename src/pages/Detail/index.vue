            ...
            <div class="chooseArea">
              ...
              <dl v-for="spuAttr in spuSaleAttrList" :key="spuAttr.id">
                ...
                <dd changepirce="0" :class="{ active: spuValue.isChecked == 1 }"
                  v-for="spuValue in spuAttr.spuSaleAttrValueList" :key="spuValue.id"
                  @click="changeChecked(spuValue, spuAttr.spuSaleAttrValueList)">
  ...
  methods: {
    ...
    async addShopcar() {
      try {
        ...
        //路由跳转
        // this.$router.push({ name: 'addcartsuccess', query: this.skuNum })
        this.$router.push({
          path: "/addcartsuccess",
